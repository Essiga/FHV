  ...
  <body onload="setCookie()">
          ...
          <div class="flex justify-between">
            <div class="flex space-x-7">
              ...
              <div class="flex items-center space-x-1">
                <a href="/PayaraHelloWorld-1.0-SNAPSHOT/index.html" class="py-4 px-2 text-gray-500 font-semibold ">Home</a>
                ...
                <a href="/PayaraHelloWorld-1.0-SNAPSHOT/schach.jsp"
                  class="py-4 px-2 text-gray-100 font-semibold hover:text-gray-100 transition duration-300">Chess</a>
              </div>
              <div class="flex items-center space-x-1">
    ...
    <main>
      ...
      <p>Chess is a board game played between two players. It is sometimes called Western chess, or international chess to distinguish it from related games such as xiangqi. The current form of the game emerged in Southern Europe during the second half of the 15th century after evolving from similar, much older games of Indian and Persian origin. Today, chess is one of the world's most popular games, played by millions of people worldwide.
        Chess is an abstract strategy game and involves no hidden information. It is played on a square chessboard with 64 squares arranged in an eight-by-eight grid. At the start, each player (one controlling the white pieces, the other controlling the black pieces) controls sixteen pieces: one king, one queen, two rooks, two knights, two bishops, and eight pawns. The object of the game is to checkmate the opponent's king, whereby the king is under immediate attack (in "check") and there is no way for it to escape. There are also several ways a game can end in a draw.</p>
    </div>
    <br/>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">Schruns</div>
                      <div class="text-sm text-gray-500">Grütweg 6</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">HS Schruns Dorf</div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">Partenen</div>
                      <div class="text-sm text-gray-500">Außerbofa 12</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">Schachclub Gaschurn</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      09.07.2022
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      ...
                      <div class="text-sm text-gray-500">Achweg 69</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">Schachverband Braz</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      30.10.2022
                    </td>
